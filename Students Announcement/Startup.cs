...
using Students_Announcement.Data;
...
namespace Students_Announcement
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<AnnouncementContext>(options => options.UseSqlServer(Configuration.GetConnectionString("AnnouncementConnection")));
